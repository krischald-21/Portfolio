            ...
            <main className="min-h-screen flex items-center justify-center px-6 py-24">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-7xl w-full items-center">
                    ...
                    <div>
                        ...
                        >
                            I’m <strong className="text-blue-500">Krischal Dhungel</strong>, a computer Science graduate student and a software engineer with a passion for building creative, intelligent systems. With experience in full-stack web development and growing expertise in AI, I enjoy working at the intersection of design, interactivity, and problem solving.
                            <br /><br />
